...
| CVC             | String | CVC code. Only valid for credit cards. **Important**: PCI DSS does not permit storing of CVC (Card Verification Code). PayFabric will only accept CVC for real-time processing and will not store CVC for future use. |  
