...
public class RetrieveAll {
	...
	public void retrieveAllGatewayAccounts() {
		...
		try {
			...
			String url = "https://sandbox.payfabric.com/v1/rest/api/setupid";
			URL obj = new URL(url);
            ...
            // Go to https://github.com/PayFabric/APIs/blob/v1/Sections/Objects.md#gateway-account for more details about gateway account object.
            // ------------------------------------------------------
