...
module PayFabric
  ...
  module GatewayAccount
    ...
    module Sandbox
      ...
      #  [Info](https://github.com/PayFabric/APIs/blob/v1/Sections/PaymentGatewayProfiles.md#retrieve-payment-gateway-profiles)
      #
      #  Example
      #    
      ...
      #      ]
      #    
      #  @return [Array of Gateway Account](https://github.com/PayFabric/APIs/blob/v1/Sections/Objects.md#gateway-account)
      #
      def retrieve_all(device_id, password)
        url = "https://sandbox.payfabric.com/v1/rest/api/setupid"
        Share::retrieve_all(url, device_id, password)
      end  

      #  ## Retrieve a Gateway Account Profile By Id
      #  [Info](https://github.com/PayFabric/APIs/blob/v1/Sections/PaymentGatewayProfiles.md#retrieve-a-payment-gateway-profile)
      #
      #  +id+ - profile id 
      # 
      #  Example
      ...
      #    hash # => {"ID" => "123"} 
      #
      # @return [Gateway Account](https://github.com/PayFabric/APIs/blob/v1/Sections/Objects.md#gateway-account)
      #
      def retrieve(device_id, password, id)
        url = "https://sandbox.payfabric.com/v1/rest/api/setupid/#{id}"
    ...
    module Live
      ...
      def retrieve_all(device_id, password)
        url = "https://www.payfabric.com/v1/rest/api/setupid"
        Share::retrieve_all(url, device_id, password)
      end  
      # see Sandbox::retrieve
      def retrieve(device_id, password, id)
        url = "https://www.payfabric.com/v1/rest/api/setupid/#{id}"
        Share::retrieve(url, device_id, password)
      end
    end
  end
